...
import BreastCancerDiagnoserBadge from 'assets/img/Breast_Cancer_Diagnoser_Badge_s2.png'
      ...
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            //   <LineStyle className={classes.dropdownIcons} /> Presentation Page1
            // </Link>,
            <Link to="/breast-cancer-diagnoser-intro" className={classes.dropdownLink}>
              <img className={classes.dropdownIcons} src={BreastCancerDiagnoserBadge} /> Breast Cancer Diagnoser
            </Link>
          ]}
        />
      </ListItem>
