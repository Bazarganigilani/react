...
export default function PresentationPage() {
  ...
  return (
    <div>
      ...
      />
      <Parallax
        image={require("assets/img/header_diagnoser.jpg")}
          ...
          <GridContainer>
            <GridItem>
              <div className={classes.brand}>
                <h1>
                  Online Diagnoser
                {/*<span className={classes.proBadge}>Inc</span> */}
                </h1>
                <h3 className={classes.title}>
                  Fast Reliable and Effective Solutions in Healthcare
                </h3>
              </div>
            </GridItem>
          </GridContainer>
